...
class MainWindow:
    def __init__(self):
        ...
        self.rgb = cv2.imread("./old_rgb_20/left_pyramid_sample_0.png")
    ...
    #    scene_bottom_right.scene = o3d.visualization.gui.Button()
        ...
        self.next_button = gui.Button(str(self.end_files_count) + "/120")
    ...
    def left_choice_button_mode(self):
        if self.end_files_count != 121:
            self.end_files_count += 1
            self.next_button.text = str(self.end_files_count) + "/120"
            self.left_write()
            self.add_new_geometry()
        elif self.end_files_count == 121:
    ...
    def reset_geometry(self):
        ...
        self.rgb2 = cv2.imread("./old_rgb_20/left_pyramid_" + self.xyz_files[self.next_xyz][0].split(" ")[2] + "_0.png")
